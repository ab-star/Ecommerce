...
export class InternalMasterProductController {
  ...
  @httpPost(
    '/',
    determineInternalAccessType(true),
    validateRequest({ body: MasterProductSchema })
  )
  public async createMasterProduct(
    ...
    try {
      const result = await this.masterProductService.createMasterProduct(
        masterProductData,
        true
      );
      res
  ...
  @httpGet(
    '/',
    determineInternalAccessType(true),
    validateRequest({ query: MasterProductQuerySchema })
  )
  ...
  @httpDelete(
    '/:id',
    determineInternalAccessType(true),
    validateRequest({ params: MasterProductPathSchema })
  )
